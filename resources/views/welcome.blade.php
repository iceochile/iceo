    ...
    <ul role="list" class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 px-4">
            <li class="col-span-1 bg-white rounded-lg shadow divide-y divide-gray-200">
                ...
                <div class="flex-1 truncate">
                    ...
                    <h3 class="text-gray-900 text-sm font-medium truncate">RidersChilenos</h3>
            ...
            <li class="col-span-1 bg-white rounded-lg shadow divide-y divide-gray-200">
                ...
                <div class="flex-1 truncate">
                    <div class="flex items-center space-x-3">
                    <h3 class="text-gray-900 text-sm font-medium truncate">i-ceo</h3>
                    <span class="flex-shrink-0 inline-block px-2 py-0.5 text-green-800 text-xs font-medium bg-green-100 rounded-full">Activo</span>
                    </div>
            ...
            <li class="col-span-1 bg-white rounded-lg shadow divide-y divide-gray-200">
                ...
                <div class="flex-1 truncate">
                    <div class="flex items-center space-x-3">
                    <h3 class="text-gray-900 text-sm font-medium truncate">Veggiefood</h3>
                    <span class="flex-shrink-0 inline-block px-2 py-0.5 text-green-800 text-xs font-medium bg-green-100 rounded-full">Activo</span>
                    </div>
            ...
            </li><li class="col-span-1 bg-white rounded-lg shadow divide-y divide-gray-200">
                <div class="w-full flex items-center justify-between p-6 space-x-6">
                <div class="flex-1 truncate">
                    <div class="flex items-center space-x-3">
                    <h3 class="text-gray-900 text-sm font-medium truncate">PetFansChile</h3>
                    <span class="flex-shrink-0 inline-block px-2 py-0.5 text-green-800 text-xs font-medium bg-green-100 rounded-full">Activo</span>
                    </div>
                    <p class="mt-1 text-gray-500 text-sm truncate">$1.230.000</p>
                </div>
