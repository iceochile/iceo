        ...
        <div class="container py-8 ">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    {!! Form::model(['route'=>'tiendas.store',$tienda,'files'=>true , 'autocomplete'=>'off']) !!}
                        @csrf
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <figure>
                                @isset($tienda->logo)
                                    <img id="picture" class="w-full h-64 object-cover object-center"src="{{Storage::url($tienda->logo)}}" alt="">
                                    @else
