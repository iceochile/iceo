...
<div>
    ...
    <div class="flex overflow-hidden bg-white md:pt-16">
       <aside id="sidebar" class="fixed hidden z-20 h-full top-0 left-0 pt-16 flex lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75" aria-label="Sidebar">
            @livewire('tienda.nav-tiendas',['tienda_id'=>$tienda->id])
       </aside>
          ...
          <main>
             <div class="pt-6 px-4">
                  <h1 class="text-center my-4">Listado de Trabajadores</h1>
                    <div class="w-12/12 mx-auto max-w-6xl" x-data="{alert:true}">
                        @if (session('info'))
                           
                              <div x-show="alert" class="font-regular relative block w-full max-w-screen-md rounded-lg bg-green-500 px-4 py-4 text-base text-white mb-4 mx-auto" data-dismissible="alert">
                        ...
                        @if (session('eliminado'))
                              ...
                              <div x-show="alert" class="font-regular relative block w-full max-w-screen-md rounded-lg bg-red-500 px-4 py-4 text-base text-white mb-4 mx-auto" data-dismissible="alert">
                                 <div class="absolute top-4 left-4">
                                    <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                        ...
                        <div class="p-4 col-span-12 md:col-span-6">
                           <div class="mx-auto grid grid-cols-2 gap-x-8 gap-y-4">
                              ...
                              {!! Form::open(['route'=>'users.store','files'=>true , 'autocomplete'=>'off']) !!}
                                 ...
                                 <div class="mt-2">
                                 {!! Form::text('name', null , ['class' => 'block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6']) !!}
                                 </div>
                              ...
                              <div class="mt-2">
                                 {!! Form::text('slug', null , ['readonly'=>'redonly','class' => 'block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6','placeholder'=>'@i-ceo.cl']) !!}
                              </div>
                           ...
                           <div class="mt-6 flex items-center justify-end gap-x-6">
                              <div class="flex justify-end">
                                 {!! Form::submit('Ingresar', ['class'=>'font-bold py-2 px-4 rounded bg-blue-500 text-white cursor-pointer']) !!}
                           </div>
                               ...
                               <table class="min-w-full table divide-y divide-gray-200">
                                   <thead class="">
                                       <tr class="bg-primary text-center">
                                           <th class="w-1/6 min-w-[140px] text-lg font-semibold text-white py-4 lg:pt-6 px-3 lg:px-4 border-l border-transparent">ID</th>
                                           <th class="w-1/6 min-w-[140px] text-lg font-semibold text-white py-4 lg:pt-6 px-3 lg:px-4 border-l border-transparent">Nombre</th>
                                           <th class="w-1/6 min-w-[140px] text-lg font-semibold text-white py-4 lg:pt-6 px-3 lg:px-4 border-l border-transparent">Correo electrónico</th>
                                           <th class="w-1/6 min-w-[140px] text-lg font-semibold text-white py-4 lg:pt-6 px-3 lg:px-4 border-l border-transparent">Opciones</th>
                                       </tr>
                                   </thead>
                                   <tbody class="bg-white divide-y divide-gray-200">
                                       @foreach ($users->reverse() as $user)
                                           <tr>
                                               <td class="w-1/6 min-w-[140px] text-center py-4 lg:pt-6 px-3 lg:px-4 border-l border-transparent">{{ $user->id }}</td>
                                               <td class="w-1/6 min-w-[140px] text-center py-4 lg:pt-6 px-3 lg:px-4 border-l border-transparent">{{ $user->name }}</td>
                                               <td class="w-1/6 min-w-[140px] text-center py-4 lg:pt-6 px-3 lg:px-4 border-l border-transparent">{{ $user->email }}</td>
                                                <td class="w-1/6 min-w-[140px] text-center py-4 lg:pt-6 px-3 lg:px-4 border-l border-transparent">
