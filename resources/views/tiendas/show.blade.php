                   ...
                   <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                    <div class="flex justify-center mb-4">
                        <div class="grid grid-cols-1">
                            <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900 text-center">$6.158.340</span>
                            <span class="text-xs leading-none font-bold text-gray-900 text-center">Total de Gastos</span>
                        </div>
                    </div>
                        <a href="{{route('horas.trabajador',$tienda)}}">
                        ...
                        <a href="{{route('gastos.tienda',$tienda)}}">
                            <div class="bg-blue-900 hover:bg-blue-800 shadow rounded-lg p-4 sm:p-6 xl:p-8 mb-2 cursor-pointer">
                                <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <span class="text-2xl sm:text-3xl leading-none font-normal text-white">$4.690.120</span>
                                    <h3 class="text-base font-bold text-white">Pago de insumos</h3>
                                </div>
                                <div class="ml-5 w-0 flex items-center justify-end flex-1 text-white text-base font-bold">
                                    32.9%
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="bg-gray-800 hover:bg-gray-700 shadow rounded-lg p-4 sm:p-6 xl:p-8 mb-2 cursor-pointer hidden">
                                <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <span class="text-2xl sm:text-3xl leading-none font-bold text-white">385</span>
                                    <h3 class="text-base font-bold text-white">User signups this week</h3>
                                </div>
                                <div class="ml-5 w-0 flex items-center justify-end flex-1 text-white text-base font-bold">
                                    -2.7%
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="mb-4 flex items-center justify-between hidden">
                            <div>
