    ...
    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
       <div class="flex-1 px-3 bg-white divide-y space-y-1">
          <ul class="space-y-2 pb-2">
             ...
             <li>
                <a href="{{route('tiendas.show',$tienda)}}" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
             ...
             <li>
                <a href="{{route('horas.trabajador',$tienda)}}" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                   <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path>
                   </svg>
                   <span class="ml-3 flex-1 whitespace-nowrap">Trabajadores</span>
                </a>
             </li>
             @if(Route::currentRouteName() === 'horas.trabajador' || Route::currentRouteName() === 'listado.trabajadores' ) 
               <li>
                  <a href="{{route('listado.trabajadores',$tienda)}}" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group @if(Route::currentRouteName() === 'tiendas.productos.manual') bg-gray-200 @endif">
                     
                     <span class="ml-9 flex-1 whitespace-nowrap">Listado de Trabajadores</span>
                  </a>
               </li>
            
            @endif
             <li>
                <a href="{{route('gastos.tienda',$tienda)}}" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                   <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
